...
generateNavLine: function () {
    ...
    var headingAngle = obj.GetAzimuth(longetside.firstDot.latitude, longetside.firstDot.longitude, longetside.secondDot.latitude, longetside.secondDot.longitude);
    ...
    basePointOffsetArray.push(obj.computeOffset(cutPointInLine[0].latitude, cutPointInLine[0].longitude, this.data.totalOperationArea[this.data.totalOperationArea.length - 1][0].operateWidth / 2, headingAngle + 90));
    basePointOffsetArray.push(obj.computeOffset(cutPointInLine[1].latitude, cutPointInLine[1].longitude, this.data.totalOperationArea[this.data.totalOperationArea.length - 1][0].operateWidth / 2, headingAngle + 90));
    ...
    if (crossPoints.length > 0) {
      while (crossPoints.length > 0) {
        ...
        basePointOffsetArray[0] = obj.computeOffset(basePointOffsetArray[0].latitude, basePointOffsetArray[0].longitude, this.data.totalOperationArea[this.data.totalOperationArea.length - 1][0].operateWidth, headingAngle + 90);
        basePointOffsetArray[1] = obj.computeOffset(basePointOffsetArray[1].latitude, basePointOffsetArray[1].longitude, this.data.totalOperationArea[this.data.totalOperationArea.length - 1][0].operateWidth , headingAngle + 90);
